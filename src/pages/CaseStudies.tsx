    ...
    <div className="bg-white">
      ...
      <section className="py-32 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <Link to="/contact" className="bg-secondary text-white px-10 py-4 font-headline font-bold text-lg hover:shadow-lg hover:bg-secondary/90 transition-all cursor-pointer inline-flex">
